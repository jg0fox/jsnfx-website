...
slug: "atlassian"
description: "Helping Jira and Confluence admins sign up for and set up their new accounts."
...
featured: true
thumbnail: "/portfolio/atlassian/atlassian-admin-interface-screenshot-1.png"
heroImage: "/portfolio/atlassian/atlassian-logo-gradient-blue.svg"
order: 3
---

## A large project with many stakeholders

![Project stakeholders diagram](/portfolio/atlassian/atlassian-admin-interface-screenshot-1.png)
...
![Admin narrative arc diagram](/portfolio/atlassian/atlassian-admin-interface-screenshot-2.png)

The following example demonstrates an attempt to map our narrative arc to key onboarding moments.

![Narrative arc to onboarding mapping](/portfolio/atlassian/atlassian-jira-admin-dashboard.png)
...
![Content model iterations](/portfolio/atlassian/atlassian-confluence-setup-screen.png)
...
![Project results document](/portfolio/atlassian/atlassian-admin-configuration-panel.png)

![Final copy documentation](/portfolio/atlassian/atlassian-admin-settings-interface.png)

![Confluence onboarding flow screenshot](/portfolio/atlassian/atlassian-admin-onboarding-flow.png)

An excerpt from the Confluence onboarding flow.

## Want the full portfolio presentation?

Like a proper haircut, my portfolio is best experienced in-person.
