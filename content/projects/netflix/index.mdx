...
slug: netflix
description: >-
  A speculative project exploring content hypotheses, guidelines, and Figma
  components for Netflix payments experiments.
...
technologies:
  - Figma
  - Baymard Research
  - 18F Hypothesis Framework
thumbnail: "/projects/netflix/netflix-logo.png"
heroImage: "/projects/netflix/netflix-logo.png"
button1Label: View Figma project files
button1Url: "https://www.figma.com/file/yMKK14OjzvgOVFRUVpkJ9p/Content-opportunities-for-Netflix-payments?type=design&node-id=1%3A615&mode=design&t=hyqGe3QYPkKXntHk-1"
button1Icon: external
---

> This is speculative work. I am not an employee or contractor of Netflix, and this project was not commissioned by Netflix.
...
![Third-party payment flow diagram](/projects/netflix/third-party-data-export-insights.png)
...
![Content hypothesis cards for Netflix payments](/projects/netflix/netflix-payment-content-hypotheses.svg)
...
![Figma component variants for hypothesis cards](/projects/netflix/figma-hypothesis-card-components.png)

Each hypothesis card exists as a Figma component in the complementary design file.

![Hypothesis card aligned state](/projects/netflix/figma-design-screenshot-1.png)

![Hypothesis card misaligned state](/projects/netflix/figma-design-screenshot-2.png)
...
![Netflix payments content matrix in Figma](/projects/netflix/figma-content-matrix.png)
