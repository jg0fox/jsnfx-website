...
const experience = [
  {
    ...
    bullets: [
      ...
      "Building the infrastructure to bring content standards into our AI-forward content system",
    ],
  },
  {
  ...
  return (
    <article className="max-w-3xl resume-print-article">
      ...
      <nav className="flex items-center gap-3 text-sm text-text-muted mb-8 print:hidden">
        ...
        <span>/</span>
        <Link href="/netflix" className="hover:text-palm-leaf transition-colors">
          Netflix
        </Link>
        <span>/</span>
        <span>Resume</span>
