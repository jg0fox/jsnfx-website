      ...
      <div className="lg:flex lg:gap-12">
        ...
        <div className="flex-1 max-w-3xl space-y-12">
          ...
          <section id="trust-framework" className="prose-section scroll-mt-24">
            ...
            {/* Callout */}
            <div className="bg-palm-leaf/5 border-l-4 border-palm-leaf p-4 rounded-r-lg">
          ...
          <section id="financial-services" className="prose-section scroll-mt-24">
            ...
            {/* The pitch callout */}
            <div className="bg-bronze-spice/10 border-l-4 border-bronze-spice p-4 rounded-r-lg mb-6">
            ...
            <p className="text-text-secondary mb-3">From the keynote panel:</p>
            <ol className="list-decimal list-inside space-y-2 text-text-secondary mb-6">
          ...
          <section id="enterprise-buyers" className="prose-section scroll-mt-24">
            ...
            <p className="text-text-secondary mb-2 font-medium">Cases to know:</p>
            <ul className="list-disc list-inside space-y-1 text-text-secondary mb-4">
            ...
            <p className="text-text-secondary mb-2 font-medium">What customers ask after churn:</p>
            <ul className="list-disc list-inside space-y-1 text-text-secondary mb-6">
            ...
            <p className="text-text-secondary mb-3">Key distinctions that matter:</p>
            <ul className="list-disc list-inside space-y-1 text-text-secondary mb-4">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-soft-linen-dark">
                    <th className="text-left py-2 pr-4 font-semibold text-text-primary">Stakeholder</th>
                    <th className="text-left py-2 pr-4 font-semibold text-text-primary">What they care about</th>
                    <th className="text-left py-2 font-semibold text-text-primary">Content they need</th>
                  </tr>
                </thead>
                <tbody className="text-text-secondary">
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Economic buyer</td>
                    <td className="py-2 pr-4">ROI, cost justification</td>
                    <td className="py-2">ROI calculators, business cases</td>
                  </tr>
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Champion</td>
                    <td className="py-2 pr-4">Making the case internally</td>
                    <td className="py-2">One-pagers they can forward</td>
                  </tr>
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Compliance/Legal</td>
                    <td className="py-2 pr-4">Risk, audit trails, regulatory defensibility</td>
                    <td className="py-2">Security whitepapers, compliance matrices</td>
                  </tr>
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">End users</td>
                    <td className="py-2 pr-4">Does it actually work for my tasks?</td>
                    <td className="py-2">Benchmarks, workflow docs, prompt templates</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Executives</td>
                    <td className="py-2 pr-4">Strategic alignment, peer validation</td>
                    <td className="py-2">Peer case studies, board-ready materials</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-soft-linen-dark">
                    <th className="text-left py-2 pr-4 font-semibold text-text-primary">VP Sales Ops cares about</th>
                    <th className="text-left py-2 font-semibold text-text-primary">CCO cares about</th>
                  </tr>
                </thead>
                <tbody className="text-text-secondary">
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Time to value</td>
                    <td className="py-2">Audit trails</td>
                  </tr>
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Workflow integration</td>
                    <td className="py-2">Regulatory defensibility</td>
                  </tr>
                  <tr className="border-b border-soft-linen-dark/50">
                    <td className="py-2 pr-4">Measurable outcomes</td>
                    <td className="py-2">Evidence of controls</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Speed and minimal friction</td>
                    <td className="py-2">Thoroughness and caution</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="principles" className="prose-section scroll-mt-24">
            ...
            <p className="text-text-secondary mb-3">From my research into AI onboarding best practices:</p>
          ...
          <section className="text-center py-12 mt-8 border-t border-soft-linen-dark">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-text-secondary hover:text-palm-leaf transition-colors"
              >
