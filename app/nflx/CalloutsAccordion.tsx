          ...
          <motion.span
            ...
            animate={{
              ...
              boxShadow: [
                ...
                "0 0 8px 1px rgba(229, 9, 20, 0.25)",
                "0 0 14px 2px rgba(229, 9, 20, 0.35)",
                "0 0 18px 3px rgba(229, 9, 20, 0.4)",
                "0 0 14px 2px rgba(229, 9, 20, 0.32)",
                "0 0 10px 2px rgba(229, 9, 20, 0.22)",
                "0 0 6px 1px rgba(229, 9, 20, 0.12)",
                "0 0 0px 0px rgba(229, 9, 20, 0)",
                "0 0 0px 0px rgba(229, 9, 20, 0)",
                "0 0 0px 0px rgba(229, 9, 20, 0)",
              ],
