...
export const metadata: Metadata = {
  ...
  description:
    "Cover letter and relevant work for the Staff Systems Designer, Language role at Netflix.",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <article className="space-y-12">
          ...
          <div>
            ...
            <p className="text-text-secondary mt-1 flex flex-wrap items-center gap-3">
              ...
              <span className="flex items-center gap-2">
                ...
                <a
                  href="/jason-fox-resume-netflix.pdf"
                  download
                  className="inline-flex items-center gap-1 text-xs font-medium text-palm-leaf hover:text-palm-leaf-3 transition-colors"
                >
      ...
      <section className="max-w-3xl">
        <div className="space-y-5 text-text-secondary leading-relaxed">
          ...
          <p>
            Over the last 2 years, I've found myself responsible for building
            storage, retrieval, delivery, and management infrastructure for our
            team's decentralized corpus of content standards. I've written the
      ...
      <section className="bg-soft-linen-light border border-soft-linen-dark rounded-lg p-8 text-center">
        ...
        <p className="text-text-secondary mb-6 max-w-md mx-auto">
          ...
          information architecture, and content governance can help Netflix's
          language systems become a superpower.
        </p>
