  ...
  return (
    <article className="max-w-3xl resume-print-article">
      ...
      <nav className="flex items-center gap-3 text-sm text-text-muted mb-8 print:hidden">
        ...
        <span>/</span>
        <Link href="/nflx" className="hover:text-palm-leaf transition-colors">
          Netflix
        </Link>
        <span>/</span>
        <span>Resume</span>
      ...
      <header className="mb-8">
        ...
        <p className="mt-4 text-text-secondary italic">
          I want to design for the moments when people want to feel something.
          I think in systems, care about craft, and am as comfortable in a
